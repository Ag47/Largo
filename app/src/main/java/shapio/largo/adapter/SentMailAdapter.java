...
public class SentMailAdapter extends RecyclerView.Adapter<SentMailAdapter.MyViewHolder> {
    ...
    public SentMailAdapter(Context context, ArrayList<Mail> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_target_receiver, parent, false);
